...
namespace MikietaApi.Migrations
{
    ...
    [Migration("20240603214535_OrderedIngredient_OrderedProduct")]
    partial class OrderedIngredient_OrderedProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderedIngredientEntityOrderedProductEntity", b =>
                {
                    b.Property<Guid>("OrderedIngredientsId")
                        .HasColumnType("TEXT");

                    b.Property<Guid>("OrderedProductsId")
                        .HasColumnType("TEXT");

                    b.HasKey("OrderedIngredientsId", "OrderedProductsId");

                    b.HasIndex("OrderedProductsId");

                    b.ToTable("OrderedProductOrderedIngredient", (string)null);
                });
            ...
            modelBuilder.Entity("OrderedIngredientEntityOrderedProductEntity", b =>
                {
                    b.HasOne("MikietaApi.Data.Entities.OrderedIngredientEntity", null)
                        .WithMany()
                        .HasForeignKey("OrderedIngredientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MikietaApi.Data.Entities.OrderedProductEntity", null)
                        .WithMany()
